...
History uses `feat:`, `fix:`, `security:`, `chore:`, and story commits like `STORY-012a: ...`. Git history is the best tool to track progress, so commit often and with meaningful messages. Save each meaningful working checkpoint with a clear message after tests/builds pass. PRs should include summary, affected routes, test results, screenshots for visual changes, and relevant docs/story IDs.
