  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <ServiceSchema
        ...
        description="Công cụ lập lá số tử vi miễn phí. Nhận 3 luận giải đầu tiên không tốn phí. Nâng cấp để xem báo cáo đầy đủ 12 cung."
      ...
      <section id="form" className="mb-12">
        <form
          ...
          noValidate
        >
          {/* Persistent aria-live region for form errors */}
          <div
            aria-live="polite"
            aria-atomic="true"
            className="sr-only"
          ...
          >
            {Object.keys(errors).length > 0
              ? `Có ${Object.keys(errors).length} lỗi trong biểu mẫu: ${Object.values(errors).join(', ')}`
              : submitted
