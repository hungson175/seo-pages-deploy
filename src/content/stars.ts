...
const STAR_PROFILES: Record<PriorityStarSlug, StarProfile> = {
  ...
  'thien-phu': {
    ...
    name: 'Thiên Phủ',
    hanTu: '天府',
    archetype: 'kho tàng, năng lực gìn giữ và quản trị nền tảng',
    role: 'tích lũy nguồn lực, bảo quản tài sản, vận hành ổn định và xây cảm giác an toàn',
    core: 'Thiên Phủ thường được hiểu như hình ảnh một kho chứa: biết giữ, biết phân bổ và biết tạo nền cho việc dài hạn. Khi đọc sao này, không nên biến nó thành lời hứa về tài sản. Cách hiểu an toàn hơn là xem người đó có xu hướng quản trị nguồn lực ra sao: cẩn trọng, đều đặn, thích chuẩn bị và ưu tiên sự bền vững.',
    temperament: 'điềm tĩnh, thích trật tự, không vội mở rộng khi nền tảng chưa rõ',
    gift: 'biết quản lý nguồn lực, tạo niềm tin, giữ ổn định và xây quan hệ dài hạn',
    caution: 'dễ chậm đổi mới, ngại thử điều mới hoặc giữ quá nhiều vì sợ thiếu an toàn',
    menhCue: 'nhấn mạnh nhu cầu ổn định, năng lực sắp xếp đời sống và cách người đó tạo cảm giác đáng tin',
    thanCue: 'cho thấy trưởng thành qua việc dùng nguồn lực có mục đích, không chỉ giữ lại cho yên tâm',
    quanCue: 'nghiêng về vận hành, quản trị, tài chính thận trọng, hậu cần, quản lý tài sản, dịch vụ ổn định hoặc vai trò giữ nhịp cho tổ chức',
    taiCue: 'gợi ý nguồn lực nên đi qua kế hoạch, ghi chép, dự phòng và tiêu chí sử dụng rõ ràng',
    relationshipCue: 'cần sự tin cậy và nhịp sống ổn định; nếu quá giữ an toàn, quan hệ dễ thiếu trao đổi mới',
    wellbeingCue: 'nên giữ nhịp nghỉ đều, không ôm quá nhiều trách nhiệm hậu trường và dành thời gian làm mới không gian sống',
    combinationFocus: 'Thiên Phủ cần đọc cùng Tử Vi để xem trục điều phối, cùng Vũ Khúc để xem quản trị nguồn lực, cùng Tả Hữu để xem khả năng được hỗ trợ trong hệ thống.',
    positivePairings: ['Tử Vi - Thiên Phủ', 'Vũ Khúc - Thiên Phủ', 'Thiên Phủ gặp Tả Phù/Hữu Bật', 'Thiên Phủ gặp Văn Xương/Văn Khúc'],
    challengingPairings: ['Thiên Phủ thiếu sao hành động', 'Thiên Phủ gặp Hóa Kỵ', 'Thiên Phủ bị sát tinh làm căng', 'Thiên Phủ quá thiên về giữ mà thiếu mở'],
    practicalAdvice: 'Nếu lá số nổi bật Thiên Phủ, hãy biến khả năng giữ nền thành kế hoạch rõ: ngân sách, lịch bảo trì, quy trình bàn giao và tiêu chí chọn việc. Điểm mạnh của Thiên Phủ không chỉ là giữ được nhiều, mà là biết nguồn lực nào cần dùng đúng lúc để đời sống bớt trì trệ.',
    questions: ['Nguồn lực nào mình đang giữ vì mục tiêu rõ, nguồn lực nào giữ vì bất an?', 'Quy trình nào giúp gia đình hoặc nhóm làm việc ổn định hơn?', 'Việc gì nên được mở ra từng bước thay vì giữ mãi trong vùng quen thuộc?'],
  },
  'cu-mon': {
    slug: 'cu-mon',
    name: 'Cự Môn',
    hanTu: '巨門',
    archetype: 'cánh cửa lớn, ngôn ngữ, phản biện và năng lực làm rõ điều bị che khuất',
    role: 'giao tiếp, phân tích lời nói, đặt câu hỏi, thương lượng và xử lý mâu thuẫn bằng thông tin',
    core: 'Cự Môn thường gợi về cái miệng, cánh cửa và khả năng làm rõ vấn đề qua ngôn ngữ. Khi đọc sao này, điểm chính không phải là gán người đó thị phi, mà là xem họ dùng lời nói ra sao: để giải thích, chất vấn, bảo vệ quan điểm hay vô tình làm mọi chuyện căng hơn.',
    temperament: 'thích phân tích, chú ý chi tiết trong lời nói và không dễ chấp nhận câu trả lời mơ hồ',
    gift: 'biết đặt câu hỏi, trình bày vấn đề, nhìn lỗ hổng lập luận và thương lượng tiêu chuẩn',
    caution: 'dễ nói quá nhiều, nghiêng về tranh luận hoặc giữ trong lòng những điều chưa được giải thích',
    menhCue: 'nhấn mạnh nhu cầu được nói rõ, được hiểu đúng và được tham gia vào việc phân định thông tin',
    thanCue: 'cho thấy trưởng thành qua việc dùng lời nói có trách nhiệm, biết lúc nào cần hỏi và lúc nào cần lắng nghe',
    quanCue: 'nghiêng về truyền thông, giáo dục, tư vấn, nghiên cứu, bán hàng, hỗ trợ khách hàng hoặc công việc cần diễn giải phức tạp',
    taiCue: 'gợi ý nguồn lực đến từ năng lực trình bày, đàm phán, kiến thức chuyên môn và sự minh bạch trong thỏa thuận',
    relationshipCue: 'cần quy ước giao tiếp rõ; nếu chỉ phản biện mà thiếu xác nhận cảm xúc, người thân dễ thấy bị xét nét',
    wellbeingCue: 'nên giảm suy nghĩ lặp lại bằng ghi chú, đối thoại đúng thời điểm và nghỉ khỏi các cuộc tranh luận không cần thiết',
    combinationFocus: 'Cự Môn cần đọc cùng Thiên Cơ để xem trí phân tích, cùng Thái Dương để xem ánh sáng công khai, cùng Hóa Kỵ để xem điểm dễ hiểu lầm hoặc cần kiểm chứng kỹ.',
    positivePairings: ['Cự Môn - Thiên Cơ có tiết chế', 'Cự Môn gặp Hóa Khoa', 'Cự Môn gặp Văn Xương/Văn Khúc', 'Cự Môn được Thái Dương soi sáng'],
    challengingPairings: ['Cự Môn gặp Hóa Kỵ', 'Cự Môn thiếu sao mềm', 'Cự Môn bị sát tinh thúc lời', 'Cự Môn quá thiên về phản biện'],
    practicalAdvice: 'Nếu lá số nổi bật Cự Môn, hãy rèn ba kỹ năng: hỏi đúng, tóm tắt lại điều đã nghe và chốt việc bằng văn bản. Khi lời nói có cấu trúc, Cự Môn trở thành năng lực làm rõ; khi thiếu cấu trúc, nó dễ làm người khác phòng thủ.',
    questions: ['Mình đang hỏi để hiểu hay hỏi để thắng?', 'Việc nào cần viết rõ lại để tránh hiểu nhầm?', 'Có câu nào nên nói mềm hơn mà vẫn giữ được ý chính không?'],
  },
  'thien-dong': {
    slug: 'thien-dong',
    name: 'Thiên Đồng',
    hanTu: '天同',
    archetype: 'phúc khí mềm, khả năng thích nghi và nhu cầu sống dễ thở',
    role: 'sự mềm mại, đồng cảm, nhịp sống linh hoạt, niềm vui giản dị và khả năng hòa vào môi trường',
    core: 'Thiên Đồng thường được đọc như một nguồn năng lượng mềm: dễ cảm, dễ hòa, thích không khí nhẹ và có xu hướng tìm nhịp sống ít căng. Khi đọc sao này, không nên nói thành lời hứa về phúc lộc hay tuổi thọ. Cách đọc phù hợp là xem người đó cần điều kiện nào để cảm thấy an toàn, vui và có động lực.',
    temperament: 'dễ gần, linh hoạt, thích sự thoải mái và nhạy với bầu không khí quanh mình',
    gift: 'biết làm dịu căng thẳng, kết nối người khác, thích nghi và giữ tinh thần nhẹ nhàng',
    caution: 'dễ né áp lực, thiếu quyết đoán hoặc trì hoãn việc khó nếu môi trường quá nặng',
    menhCue: 'nhấn mạnh nhu cầu được sống mềm, có niềm vui và không bị ép vào khuôn quá cứng',
    thanCue: 'cho thấy trưởng thành qua việc biến sự mềm mại thành nhịp sống có trách nhiệm',
    quanCue: 'nghiêng về dịch vụ, giáo dục, chăm sóc khách hàng, nội dung, cộng đồng hoặc công việc cần sự đồng cảm',
    taiCue: 'gợi ý nguồn lực đến từ quan hệ tin cậy, thói quen đều và khả năng duy trì việc vừa sức',
    relationshipCue: 'cần cảm giác được lắng nghe; nếu tránh nói chuyện khó, vấn đề nhỏ có thể kéo dài',
    wellbeingCue: 'nên duy trì vận động nhẹ, lịch nghỉ đều, hoạt động tạo niềm vui và ranh giới với môi trường quá căng',
    combinationFocus: 'Thiên Đồng cần đọc cùng Thiên Lương để xem trách nhiệm mềm, cùng Thiên Cơ để xem tính linh hoạt, cùng Thái Âm để xem nhu cầu an toàn nội tâm.',
    positivePairings: ['Thiên Đồng - Thiên Lương', 'Thiên Đồng - Thái Âm', 'Thiên Đồng gặp Hóa Khoa', 'Thiên Đồng được sao ổn định nâng đỡ'],
    challengingPairings: ['Thiên Đồng thiếu sao kỷ luật', 'Thiên Đồng gặp Hóa Kỵ', 'Thiên Đồng bị sát tinh làm bất an', 'Thiên Đồng quá nghiêng về né việc khó'],
    practicalAdvice: 'Nếu lá số nổi bật Thiên Đồng, hãy thiết kế lịch sống có cả phần vui và phần cần làm. Sự mềm mại là điểm mạnh khi nó giúp phục hồi và kết nối; nó chỉ thành vướng mắc khi người xem dùng sự thoải mái để tránh quyết định cần thiết.',
    questions: ['Mình đang nghỉ để phục hồi hay để né việc cần làm?', 'Hoạt động nào đem lại niềm vui mà không làm mất nhịp kỷ luật?', 'Cuộc trò chuyện khó nào cần được nói bằng giọng nhẹ nhưng rõ?'],
  },
  'liem-trinh': {
    slug: 'liem-trinh',
    name: 'Liêm Trinh',
    hanTu: '廉貞',
    archetype: 'liêm chính, ranh giới, tiêu chuẩn và năng lực tự kiểm soát',
    role: 'kỷ luật đạo đức, nguyên tắc cá nhân, trách nhiệm, sức hút có kiểm soát và khả năng giữ ranh giới',
    core: 'Liêm Trinh nên được đọc như câu hỏi về tiêu chuẩn sống: điều gì được phép, điều gì cần giữ ranh giới và người đó xử lý sức hút cá nhân ra sao. Ở trang nền này, Liêm Trinh không được dùng để gán nhãn đạo đức hay suy diễn chuyện pháp lý. Cách đọc an toàn là nói về tự quản trị, tính liêm chính và khả năng điều chỉnh hành vi.',
    temperament: 'có nguyên tắc, nhạy với chuyện đúng sai, có sức hút riêng và không thích bị xem thường',
    gift: 'biết giữ chuẩn, tự rèn, tạo ấn tượng rõ và chịu trách nhiệm với điều mình đã chọn',
    caution: 'dễ căng vì tự ép tiêu chuẩn cao, phản ứng mạnh khi bị hiểu sai hoặc khó mềm trong quan hệ',
    menhCue: 'nhấn mạnh nhu cầu sống có nguyên tắc, được tôn trọng và tự kiểm soát hình ảnh cá nhân',
    thanCue: 'cho thấy trưởng thành qua việc dùng nguyên tắc để bảo vệ giá trị, không biến nguyên tắc thành phòng thủ',
    quanCue: 'nghiêng về quản trị tiêu chuẩn, kiểm soát chất lượng, nhân sự, vận hành, nghệ thuật biểu đạt hoặc vai trò cần trách nhiệm rõ',
    taiCue: 'gợi ý nguồn lực cần minh bạch, có ranh giới, có tiêu chí nhận việc và tránh quyết định vì cảm xúc nhất thời',
    relationshipCue: 'cần tôn trọng và nói thẳng về ranh giới; nếu giữ sĩ diện quá lâu, quan hệ dễ thiếu mềm mại',
    wellbeingCue: 'nên xả áp lực bằng vận động, sáng tạo, viết nhật ký và học cách phân biệt tiêu chuẩn với tự phán xét',
    combinationFocus: 'Liêm Trinh cần đọc cùng Thiên Tướng để xem tiêu chuẩn và hỗ trợ, cùng Tử Vi để xem trật tự, cùng nhóm Hóa để xem cách nguyên tắc được biểu hiện trong từng giai đoạn.',
    positivePairings: ['Liêm Trinh - Thiên Tướng', 'Liêm Trinh gặp Tả Phù/Hữu Bật', 'Liêm Trinh gặp Hóa Khoa', 'Liêm Trinh được Văn Xương/Văn Khúc làm mềm'],
    challengingPairings: ['Liêm Trinh gặp Hóa Kỵ', 'Liêm Trinh thiếu sao mềm', 'Liêm Trinh bị sát tinh làm nóng', 'Liêm Trinh quá thiên về tự vệ'],
    practicalAdvice: 'Nếu lá số nổi bật Liêm Trinh, hãy viết ra nguyên tắc sống và tiêu chí chọn việc để bớt phản ứng theo cảm xúc. Điểm mạnh của Liêm Trinh là biết giữ chuẩn; điểm cần học là giữ chuẩn mà vẫn còn không gian đối thoại, sửa sai và mềm lại khi cần.',
    questions: ['Ranh giới nào giúp mình bảo vệ giá trị mà không làm quan hệ đóng lại?', 'Tiêu chuẩn nào là cần thiết, tiêu chuẩn nào chỉ đến từ sợ bị đánh giá?', 'Mình có thể nói điều khó bằng cách rõ ràng mà không làm người khác phòng thủ không?'],
  },
}
