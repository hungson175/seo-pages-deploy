  ...
  const sections: ContentSection[] = [
    {
      ...
      content: `Năm ${year} mang đến nhiều biến động cho tuổi ${animal} ${gender === 'male' ? 'nam' : 'nữ'} mạng. `
        ...
        + `Năm ${year} là thời điểm thích hợp để bạn xem xét lại các kế hoạch đã đặt ra từ trước. `
    ...
    },
    {
      ...
      content: `Công việc có nhiều cơ hội mới, nhưng cần cân nhắc kỹ trước khi quyết định. `
        ...
        + `Tuy nhiên, mọi quyết định nên được cân nhắc kỹ lưỡng và tham khảo ý kiến người có kinh nghiệm. `
    ...
    },
    {
      ...
      content: `Tình cảm có thể gặp sóng gió nhỏ, cần kiên nhẫn và thấu hiểu. `
        + `Gia đạo ổn định nhưng cần quan tâm đến người thân nhiều hơn. `
        + `Đây là tham khảo, không phải tiên đoán tuyệt đối. `
        + `Năm ${year} là thời điểm tốt để vun đắp các mối quan hệ trong gia đình. `
        + `Hãy dành nhiều thời gian hơn cho người thân yêu và lắng nghe họ nhiều hơn. `
        ...
        + `Nội dung chỉ mang tính tham khảo, không phải lời tiên đoán tuyệt đối. `
        + `Hãy yêu thương và trân trọng những người luôn ở bên bạn trong mọi hoàn cảnh.`,
    },
    {
      heading: 'Sức khỏe',
      content: `Sức khỏe cần được chú ý đặc biệt trong năm ${year}. `
        ...
        + `Hãy dành thời gian nghỉ ngơi hợp lý và tránh căng thẳng kéo dài. `
        ...
        + `Khi có dấu hiệu bất thường, hãy đến cơ sở y tế để được thăm khám kịp thời. `
    ...
    },
    {
      ...
      content: `Hãy giữ tinh thần lạc quan và chủ động trong mọi tình huống. `
        ...
        + `Năm ${year} là thời điểm để bạn nhìn nhận lại các mục tiêu đã đặt ra. `
        ...
        + `Sao ${primaryStar} độ sáng ${brightness} là lời nhắc rằng bạn có nhiều tiềm năng. `
        + `Hãy chia sẻ thời gian chất lượng với gia đình và bạn bè thân thiết. `
